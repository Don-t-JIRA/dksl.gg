...
public interface MemberService {
    ...
    MemberResponse updateMember(UpdateSummonerCommand updateSummonerCommand) throws GetDataException;
    MemberResponse updateSummoner(Member member) throws RiotApiException;
